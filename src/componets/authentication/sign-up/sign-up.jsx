    ...
    <div className="container ">
      ...
      <div className="containerGF">
        <div className="container-1">
          <span className='imageGF'><img src={google} alt="googleIcon" /></span>
          <h5>Google</h5>
        </div>

        <div className="container-2">
          <span className='imageGF'><img src={facebook} alt="facebookIcon" /></span>
          <h5>Facebook</h5>
        </div>
      </div>
          ...
          <form>
            ...
            <div className="buttonContainer d-flex justify-content-center">
              <button type="button" className="btn btn-success my-3">Get Start Now</button>
            </div>
          </form>
